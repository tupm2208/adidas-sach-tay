...
var PaymentListComponent = /** @class */ (function () {
    ...
    PaymentListComponent.prototype.ngOnInit = function () {
        ...
        this.mainService.listOrder({ makh: id }).subscribe(function (data) {
    ...
    PaymentListComponent.prototype.balanceItem = function (item) {
        return item.tigia * item.tienyen - item.datcoc;
    };
    PaymentListComponent.prototype.balanceAll = function () {
        var _this = this;
        var s = 0;
