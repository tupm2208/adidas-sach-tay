...
var ReceiverListComponent = /** @class */ (function () {
    ...
    ReceiverListComponent.prototype.changeWeight = function (item) {
        ...
        this.clientService.openReceiverWeightForm(ob).subscribe(function (state) {
            if (state) {
                item.khoiluong = ob.khoiluong;
            }
        });
    };
