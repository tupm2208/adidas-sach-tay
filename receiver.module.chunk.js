...
var ReceiverListComponent = /** @class */ (function () {
    function ReceiverListComponent(matDialg, loadingService, formatService, clientService, mainService, storageService, orderService, popupService) {
    ...
    ReceiverListComponent.prototype.balanceItem = function (item) {
        return item.khoiluong * item.dongia - item.datcoc - item.phuphi;
    };
    ReceiverListComponent.prototype.balanceAll = function () {
        var _this = this;
        var s = 0;
        this.fakedData.forEach(function (item) {
            s += _this.balanceItem(item);
        });
        return s;
    };
...
var ReceiverWaitingComponent = /** @class */ (function () {
    function ReceiverWaitingComponent(loadingService, formatService, clientService, storageService, waitingOrderService, popupService) {
        this.loadingService = loadingService;
        this.formatService = formatService;
        this.clientService = clientService;
        this.storageService = storageService;
